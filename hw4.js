...
Name: Ashish Ali
Date Created: 7/6/26 
Date Modified: 7/10/26
Purpose: Homework 4 javascript file
*/ 
...
if (firstName !== "") {
    document.getElementById("greeting").innerHTML = "Welcome back, " + firstName + "! </br>";
    document.getElementById("greeting2").innerHTML = "<a href='#' id='newUser'>Not " + firstName + "? Click here to register as a new user.</a>";
